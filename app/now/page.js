...
export default function Now() {
  return (
    <div className="max-w-xl mx-auto py-12 px-4 text-gray-800">
     
      {/* Home navigation arrow */}
      <Link
        href="/"
        className="inline-block mb-6 text-2xl hover:underline text-center w-full"
      ...
      <div>
        <p className="mb-6 text-center">What I&apos;m working on now?</p>

        <p className="mb-6">
          -Finishing part 2 of Palestinian Graphic Novel: Chadi the Palestinian
          Chadi Chaplin. (Here&apos;s a teaser page). Illustrator LUKA JAPARDIZE.
          Story by me (was originally a screenplay short listed in the Sharjah
          Pitch Platform.)
        </p>
        ...
        <p className="mb-6">
          -I just finished the draft of an allegorical fiction on sheep, titled
          MAUVE. It&apos;s a 19k words novelette.
        </p>

        <p className="mb-6">
          -I&apos;m finalizing the editing of my debut graphic novel, Blue Lotus.
          It&apos;s set in Cairo, shifting between the present day and the past, and
          features the late artist Abdel Halim Hafez. I&apos;m excited to share an
          excerpt from the first chapter (text only).
        </p>
        ...
        <p className="mb-6 text-justify leading-relaxed">
          To the Golden Era&mdash; To the voices that still sing in grainy
          recordings, to the flickering film reels that refuse to fade, and to
          the timeless love stories etched in black and white. To the dreamers
          who find themselves in the echoes of a song, in the glow of an old
          theater, in the shimmer of nostalgia. This is for the past that shaped
          us, the art that endures, and the stories that refuse to be forgotten.
        </p>
        ...
        <p className="mb-6 text-justify leading-relaxed">
          I was at the movies, at an old downtown theatre playing old classics.
          I was alone because I wanted to be alone&mdash;well, I was someone who
          enjoyed my own company anyway...
        </p>

        {/* (Story text continues as in original, unchanged except formatting) */}
        <p className="mb-6 text-justify leading-relaxed">
          The wind stirred around me as I took the flower from his hand. A flash
          of light. The scent of the Nile overwhelmed me. And then&mdash;the
          world shifted.
        </p>
      </div>
