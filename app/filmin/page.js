...
//         <Link href="/" className="inline-block mb-6 text-2xl hover:underline" aria-label="Back to home">
//           &larr;
//         </Link>
//         <h1 className="text-3xl font-semibold mb-4">Filmin&apos; a Book</h1>
//         <h2 className="text-xl mb-8">A graphic novel project by Motaz H Matar &amp; Luka Japaridze</h2>
//         <div className="bg-gray-50 rounded-lg p-6 shadow-sm text-left">
//           <Image src="/FILMINABOOK-4.png" width={700} height={500} alt="Filmin' a book"/>
//           <p>
//             Each Filmin’ a Book is a cinematic journey told through still images.
...
//           </p>
//           <h1>Upcoming graphic Novels</h1>
//           <Image src="/cont2.jpg" width={700} height={500} alt="tunnel 12" />
//           <Image src="/cont1.jpg" width={700} height={500} alt="Pearl of the sea"/>

//           <p>
//             Latest Book
// written by M.H Matar and Illustrated by Luka Japaridze

// 2 Books & Counting - M.H. Matar is a filmmaker-turned-graphic novelist from Palestine. His work explores identity and memory through cinematic storytelling, collaborating with Georgian artist Luka Japaridze to freeze frames of history in ink.
//           </p>
...
//           <Image src="/chaplin.jpg" width={600} height={900} alt="Chadi Chaplin"/>
//           <p>
//             <h1>Chadi Chaplin</h1>
//             <button>Buy Now</button>
//           </p>
